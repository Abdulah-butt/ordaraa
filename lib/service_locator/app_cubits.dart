...
class AppCubits {
  static Future<void> initialize() async {
    ...
    getIt.registerSingleton<PhoneLoginCubit>(
      PhoneLoginCubit(navigator: getIt(), snackBar: getIt()),
    );
    ...
    getIt.registerSingleton<OtpVerificationCubit>(
      OtpVerificationCubit(navigator: getIt(), snackBar: getIt()),
    );
    ...
    getIt.registerSingleton<BuyerRegistrationCubit>(
      BuyerRegistrationCubit(navigator: getIt(), snackBar: getIt()),
    );
    ...
    getIt.registerSingleton<SellerRegistrationCubit>(
      SellerRegistrationCubit(navigator: getIt(), snackBar: getIt()),
    );
